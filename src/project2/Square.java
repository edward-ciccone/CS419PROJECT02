...
/**
 * Represents a Square using four points, it assumes that the points are 
 * stored in a counter-clockwise or clockwise sequence, but <code>point1</code> 
 * is always assumed to be the bottom left point of the Square, in turn this 
 * means <code>point3</code> will always be the top right point. 
 * Also it is assumed that the Squares two parallel sides are parallel to 
...
public class Square extends Rectangle {
    ...
    /**
     * Constructs a Square from four pairs of x and y values, each pair
     * is used and stored as a Point object. The Square is assumed to hold
    ...
    /**
     * Constructs a Square from four Point objects. The Square is assumed 
    ...
    /**
     * Returns the coordinates of the Square in the order they were recieved,
